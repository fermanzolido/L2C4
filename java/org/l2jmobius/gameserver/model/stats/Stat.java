...
public enum Stat {
	...
	CRITICAL_DAMAGE_ADD("critDmgAdd"), // this is another type for special critical damage mods - vicious stance,
										// critical power and critical damage SA
	...
	DEFENCE_CRITICAL_DAMAGE_ADD("defCritDamageAdd"), // Resistance to critical damage in value (Example: +100 will be
														// 100 more critical damage, NOT 100% more).
	SHIELD_RATE("rShld"),
	...
	// Run speed, walk & escape speed are calculated proportionally, magic speed is
	// a buff
	MOVE_SPEED("runSpd"),
