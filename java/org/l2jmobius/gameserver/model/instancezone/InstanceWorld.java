...
public class InstanceWorld
{
	...
	{
		final List<Npc> result = new ArrayList<>(_instance.getNpcs().size()); // Performance: Pre-allocate capacity to minimize array resizing.
	...
	{
		final List<T> result = new ArrayList<>(_instance.getNpcs().size()); // Performance: Pre-allocate capacity to minimize array resizing.
		for (Npc npc : _instance.getNpcs())
		{
