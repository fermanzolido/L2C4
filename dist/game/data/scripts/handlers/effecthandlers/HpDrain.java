...
public class HpDrain extends AbstractEffect {
	...
	public void onStart(Creature effector, Creature effected, Skill skill) {
		if (effector.isAlikeDead() || (skill.getId() == 4050 /* Cubic skill ID hardcoded to prevent double damage */)
				|| effector.isAffectedByAbnormalType(AbnormalType.INVINCIBILITY)
				|| effector.isAffectedByAbnormalType(AbnormalType.ABNORMAL_INVINCIBILITY)) {
			return;
		}
		...
		final double hpFinal = ((effector.getCurrentHp() + hpAdd) > effector.getMaxHp() ? effector.getMaxHp()
